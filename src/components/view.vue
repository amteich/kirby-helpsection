<template>
  <k-inside>
    <div class="mgfhelp">
      <nav
        v-if="navPrimary != null"
        v-show="!isMobile || show == 'menu'"
        class="mgfhelp__panel mgfhelp__sections"
      >
      ...
      <nav
        v-if="navSecondary != null"
        v-show="!isMobile || show == 'entries'"
        class="mgfhelp__panel mgfhelp__entries"
      >
        <header class="mgfhelp__header" v-show="isMobile">
          <button @click.stop="show = 'menu'">
            <svg viewBox="0 0 12 12" width="12" height="12">
              ...
              <g fill="#111111">
                <path
                  d="M11,9H1a1,1,0,0,0,0,2H11a1,1,0,0,0,0-2Z"
                  fill="#111111"
                ></path>
                <path
                  d="M11,1H1A1,1,0,0,0,1,3H11a1,1,0,0,0,0-2Z"
                  fill="#111111"
                ></path>
                <path
                  d="M11,5H1A1,1,0,0,0,1,7H11a1,1,0,0,0,0-2Z"
                  data-color="color-2"
                ></path>
              </g>
            </svg>
        ...
        <div class="mgfhelp__scrollarea">
          <ul>
            <li v-for="(item, index) in navSecondary" :key="index">
              <a
      ...
      <article class="mgfhelp__panel mgfhelp__main" v-show="show == 'main'">
        <div class="mgfhelp__header" v-show="isMobile">
          ...
          <button @click.stop="show = 'entries'" v-if="navSecondary != null">
            <svg viewBox="0 0 12 12" width="12" height="12">
              ...
              <g fill="#111111">
                <path
                  d="M10,0H2A2,2,0,0,0,0,2v8a2,2,0,0,0,2,2h8a2,2,0,0,0,2-2V2A2,2,0,0,0,10,0ZM7,2V4H2V2ZM7,7H2V5H7ZM2,8H7v2H2Zm6,2V2h2v8Z"
                  fill="#111111"
                ></path>
              </g>
            </svg>
        ...
        <div class="mgfhelp__scrollarea">
          <div class="mgfhelp__main__inner">
            <k-text v-if="content != null" v-html="content"> </k-text>
          </div>
        </div>
      </article>
    </div>
...
export default {
  ...
  mounted() {
    ...
    document
      .querySelector(".k-panel-view")
      .classList.add("k-panel-view--mgfhelp");
  },
  beforeDestroy() {
    document
      .querySelector(".k-panel-view")
      .classList.remove("k-panel-view--mgfhelp");
  },
  methods: {
    clickPrimaryNav(page) {
      if (page.hasChildren) {
        this.$api
          .get("pages/" + this.url(page.id, "children"), {
